#!/usr/bin/env node
// opencode-webui 0.7.0: optional standalone module (see README.md in this folder).
// Restored byte-identical from pre-removal revision (proxy-v2.2.0 + 2.3.0 fixes).
// Enable with AGENT_BROWSER_PROXY=1. This file only shells out to the
// agent-browser binary — it never modifies bin/agent-browser/*.exe or .meta.json.
